 ...
 */
export function bytesToWords(data: Uint8Array): Uint32Array {
 ...
 */
export function writeInt(buf: Uint8Array, offset: number, value: number): void {
...
export async function createMfFile(payload: Uint8Array, compressedSize: number, uncompressedSize: number): Promise<Uint8Array> {
  ...
  writeInt(metadata, 56, uncompressedSize);
  writeInt(metadata, 60, compressedSize);
